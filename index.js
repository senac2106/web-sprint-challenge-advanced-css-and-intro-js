...
function addArtist(artists){
   artists.push({id: 20, name: 'jesus', years: '2002 - 2021',genre: 'Web Design', nationality: 'Mexican',bio: 'i love to be on my computer, hangout with riends and family and live my life.'})
      return artists;
  }
